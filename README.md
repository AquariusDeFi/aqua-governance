...
- **Serves** the Aquarius web frontend ([`aquarius-frontend`](https://github.com/AquariusDeFi/aquarius-frontend))
  with proposal, vote, asset-token and voting-queue data.
...
- Deployed via [`aqua-governance-ansible`](https://github.com/AquariusDeFi/aqua-governance-ansible).
...
No in-repo CI configuration (no GitHub Actions / pipelines file at the time of
writing). Deployment is handled out-of-repo by the
[`aqua-governance-ansible`](https://github.com/AquariusDeFi/aqua-governance-ansible)
project.
...
- Team knowledge base: `aquarius-knowledge` vault, `repos/aqua-governance/`
  (Overview, API, Business Logic, Models, Tasks).
